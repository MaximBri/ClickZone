...
[clickzone](../../../../../README.md) / [entities/user/model/selectors](../README.md) / getUserFlags

# Function: getUserFlags()

> **getUserFlags**(`state`): `object`

Defined in: [src/entities/user/model/selectors.ts:15](https://github.com/MaximBri/ClickZone/blob/20f3f0d061a7c50a96ed5bba64acbc325a456072/client/src/entities/user/model/selectors.ts#L15)
